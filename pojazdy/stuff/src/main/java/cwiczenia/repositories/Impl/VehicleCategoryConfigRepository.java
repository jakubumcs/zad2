...
// Repozytorium kategorii nie ma @Profile – kategorie zawsze czytamy z pliku JSON,
// niezależnie od profilu (jdbc/jpa/json). Konfiguracja kategorii nie jest w bazie danych.
@Repository
