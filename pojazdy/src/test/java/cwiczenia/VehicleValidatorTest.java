...
class VehicleValidatorTest {
    ...
    @BeforeEach
    void setUp() {
        IVehicleCategoryConfigRepository repo = new InMemoryVehicleCategoryConfigRepository(
                List.of(
    ...
    private static class InMemoryVehicleCategoryConfigRepository implements IVehicleCategoryConfigRepository {
